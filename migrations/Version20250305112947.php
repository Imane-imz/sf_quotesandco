...
final class Version20250305112947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT NOT NULL, ADD slug VARCHAR(255) NOT NULL, CHANGE price price NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP slug, CHANGE price price DOUBLE PRECISION NOT NULL');
    }
}
